...
if (process.env.USING_WEBSOCKETS == "false") {
  ...
  app.post("/open_renting_box_confirmed/:parking_id/:box_id", (req, res) => {
    ...
    Box.update(
      {
        state:
          constants.RENTING_MODE_PULLING_OUT_SCOOTER_DOOR_OPEN_CONFIRMATION_RECEIVED
      },
      {
        where: { id: data.boxId }
      }
  ...
  app.post(
    "/renting_charger_unplugged/:parking_id/:box_id/:charger_state",
    (req, res) => {
      const data = { boxId: parseInt(req.params.box_id) };
      ...
      Box.update(
        {
          state:
            constants.RENTING_MODE_PULLING_OUT_SCOOTER_CHARGER_PULLED_OUT_CONFIRMATION_RECEIVED,
          occupied: false
        },
        {
  ...
  app.post(
    "/renting_box_closed/:parking_id/:box_id/:charger_state",
    (req, res) => {
      const data = { boxId: parseInt(req.params.box_id) };
      ...
      Box.update(
        {
          state:
            constants.RENTING_MODE_PULLING_OUT_SCOOTER_DOOR_CLOSED_CONFIRMATION_RECEIVED,
          lastReservationDate: dateOfReservation,
          userId: null
        },
        {
          where: { id: data.boxId }
      ...
      return res
        .send({ response: "renting-out-box-closed received" })
        .status(200);
    }
  );
  ...
  app.post("/open_box_confirmed/:parking_id/:box_id", (req, res) => {
    ...
    Box.update(
      {
        state:
          constants.RENTING_MODE_INTRODUCING_SCOOTER_DOOR_OPEN_CONFIRMATION_RECEIVED
      },
      {
        where: { id: data.boxId }
      }
  ...
  app.post("/charger_connected/:parking_id/:box_id", (req, res) => {
    ...
    Box.update(
      {
        state:
          constants.RENTING_MODE_INTRODUCING_SCOOTER_CHARGER_PLUGGED_IN_CONFIRMATION_RECEIVED,
        occupied: true
      },
      {
        where: { id: data.boxId }
  ...
  app.post("/box_closed/:parking_id/:box_id/:charger_state", (req, res) => {
    ...
    Box.update(
      {
        state:
          constants.RENTING_MODE_INTRODUCING_SCOOTER_DOOR_CLOSED_CONFIRMATION_RECEIVED,
        userId: null,
        occupied: true
      },
      {
  ...
  app.post("/open_box_parking_in_confirmed/:parking_id/:box_id", (req, res) => {
    ...
    Box.update(
      {
        state:
          constants.PARKING_MODE_INTRODUCING_SCOOTER_DOOR_OPEN_CONFIRMATION_RECEIVED,
        lastReservationDate: dateOfReservation
      },
      {
        where: { id: data.boxId }
  ...
  app.post(
    "/charger_connected_parking_in/:parking_id/:box_id/:charger_state",
    (req, res) => {
      ...
      Box.update(
        {
          state:
            constants.PARKING_MODE_INTRODUCING_SCOOTER_CHARGER_PLUGGED_IN_CONFIRMATION_RECEIVED,
          occupied: true,
          userId: userId
        },
        {
  ...
  app.post(
    "/box_closed_parking_in/:parking_id/:box_id/:charger_state",
    (req, res) => {
      ...
      Box.update(
        {
          state:
            constants.PARKING_MODE_INTRODUCING_SCOOTER_DOOR_CLOSED_CONFIRMATION_RECEIVED,
          userId: userId
        },
        {
          where: { id: data.boxId }
  ...
  app.post(
    "/open_box_parking_out_confirmed/:parking_id/:box_id",
    (req, res) => {
      ...
      Box.update(
        {
          state:
            constants.PARKING_MODE_PULLING_OUT_SCOOTER_DOOR_OPEN_CONFIRMATION_RECEIVED
        },
        {
          where: { id: data.boxId }
        }
  ...
  app.post(
    "/charger_unplugged_parking_out/:parking_id/:box_id/:charger_state",
    (req, res) => {
      ...
      Box.update(
        {
          state:
            constants.PARKING_MODE_PULLING_OUT_SCOOTER_CHARGER_PULLED_OUT_CONFIRMATION_RECEIVED
        },
        {
          where: { id: data.boxId }
        }
  ...
  app.post(
    "/box_closed_parking_out/:parking_id/:box_id/:charger_state",
    (req, res) => {
      ...
      Box.update(
        {
          state:
            constants.PARKING_MODE_PULLING_OUT_SCOOTER_DOOR_CLOSED_CONFIRMATION_RECEIVED,
          occupied: false,
          userId: null
        },
        {
...
io.on("connect", socket => {
  ...
  if (process.env.USING_WEBSOCKETS == "true") {
    socket.on("open-box-parking-in", data => {
      // to box device
      io.sockets.emit("open-box", {
        boxId: data.id,
        parkingId: data.parkingId,
        scooterPullingIn: true
      });
      ...
      setTimeout(function () {
        Box.findByPk(data.id)
          .then(data => {
            if (
              data.dataValues.state ===
                constants.PARKING_MODE_INTRODUCING_SCOOTER_ORDER_TO_OPEN_DOOR_SENT ||
              data.dataValues.state ===
                constants.PARKING_MODE_INTRODUCING_SCOOTER_DOOR_OPEN_CONFIRMATION_RECEIVED ||
              data.dataValues.state ===
                constants.PARKING_MODE_INTRODUCING_SCOOTER_CHARGER_PLUGGED_IN_CONFIRMATION_RECEIVED
              ...
              Box.update(
                ...
                .then(num => {
                  if (num == 1) {
                    ...
                    io.sockets.emit("force-free-box", {
                      boxId: data.id,
                      parkingId: data.parkingId,
                      scooterPullingIn: false,
                      forceState: true
                    });
        ...
        Box.findByPk(data.id)
          .then(data => {
            if (
              ...
              data.dataValues.state ===
              constants.PARKING_MODE_PULLING_OUT_SCOOTER_ORDER_TO_OPEN_DOOR_SENT
            ) {
              Box.update(
                {
                  state:
                ...
                .then(num => {
                  if (num == 1) {
                    ...
                    io.sockets.emit("force-occupied-box", {
                      boxId: data.id,
                      parkingId: data.parkingId,
                      scooterPullingIn: true,
                      forceState: true
                    ...
                    // refresh information in mobile phones
                    io.sockets.emit("refresh-box-state", {
      ...
      setTimeout(function () {
        Box.findByPk(data.id)
          .then(data => {
            if (
              data.dataValues.state ===
                constants.RENTING_MODE_INTRODUCING_SCOOTER_ORDER_TO_OPEN_DOOR_SENT ||
              data.dataValues.state ===
                constants.RENTING_MODE_INTRODUCING_SCOOTER_DOOR_OPEN_CONFIRMATION_RECEIVED ||
              data.dataValues.state ===
                constants.RENTING_MODE_INTRODUCING_SCOOTER_CHARGER_PLUGGED_IN_CONFIRMATION_RECEIVED
        ...
        Box.findByPk(data.id)
          .then(data => {
            if (
              ...
              data.dataValues.state ===
              constants.RENTING_MODE_PULLING_OUT_SCOOTER_ORDER_TO_OPEN_DOOR_SENT
            ) {
              Box.update(
                {
                  state:
  ...
  if (process.env.USING_WEBSOCKETS == "false") {
    ...
    socket.on("open-box-renting-in", data => {
      ...
      axios
        .post(`${parking_url}/open_box_renting_in/${data.id}`)
        .then(res => {
    ...
    socket.on("open-box-renting-out", data => {
      ...
      axios
        .post(`${parking_url}/open_box_renting_out/${data.id}`)
        .then(res => {
    ...
    socket.on("open-box-parking-in", data => {
      ...
      axios
        .post(`${parking_url}/open_box_parking_in/${data.id}`)
        .then(res => {
    ...
    socket.on("open-box-parking-out", data => {
      ...
      axios
        .post(`${parking_url}/open_box_parking_out/${data.id}`)
        .then(res => {
      ...
      Box.findByPk(data.boxId)
        .then(data => {
          ...
          if (
            ...
            io.sockets.emit("refresh-box-state", {
              boxId: data.dataValues.id,
              doorClosedBeforeDetectorFires: true
            });
  ...
  socket.on("something-changed", data => {
    ...
    if (data.reservation != null && data.reservation == true) {
      ...
      io.sockets.emit("reserve-box", {
        boxId: data.box_id,
        parkingId: data.parking_changed
      });
    }

    if (data.reservation != null && data.reservation == false) {
      console.log("unreserve-box sent");
      io.sockets.emit("unreserve-box", {
        boxId: data.box_id,
        parkingId: data.parking_changed,
        scooterPullingIn: false
      });
